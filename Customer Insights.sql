...
select count(customer_id) total_no_of_customer
from customers;
...
select count(order_id) as orders_30_or_older
from orders o
join customers c
...
select country_name,count(order_id) no_of_order
from country c
join orders o
...
SELECT round(AVG(c.age)) AS average_age_vitamins
FROM customers c
